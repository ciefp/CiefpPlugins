...
PLUGIN_LIST = [
    ...
    ("CiefpEasySetup", "/usr/lib/enigma2/python/Plugins/Extensions/CiefpPlugins/icons/CiefpEasySetup.png", "wget -q --no-check-certificate https://raw.githubusercontent.com/ciefp/CiefpEasySetup/main/installer.sh -O - | /bin/sh", "CiefpEasySetup"),
    ...
    ("CiefpPiconManager", "/usr/lib/enigma2/python/Plugins/Extensions/CiefpPlugins/icons/CiefpPiconManager.png", "wget -q --no-check-certificate https://raw.githubusercontent.com/ciefp/CiefpPiconManager/main/installer.sh -O - | /bin/sh", "CiefpPiconManager"),
    ("CiefpSignalInfo", "/usr/lib/enigma2/python/Plugins/Extensions/CiefpPlugins/icons/CiefpSignalInfo.png", "wget -q --no-check-certificate https://raw.githubusercontent.com/ciefp/CiefpSignalInfo/main/installer.sh -O - | /bin/sh", "CiefpSignalInfo"),
...
class CiefpPluginsPanel(Screen):
    ...
    def __init__(self, session):
        ...
        self["title"] = Label(f"..:: Ciefp Plugins (NO.43) ::.. (Version {PLUGIN_VERSION})")
        self["actions"] = ActionMap(["OkCancelActions", "ColorActions", "DirectionActions"], {
            "cancel": self.exit,
            "red": self.exit,
...
def Plugins(**kwargs):
    ...
    return [PluginDescriptor(name="Ciefp Plugins", description=f"Panel for Ciefp plugins NO.43 (Version {PLUGIN_VERSION})", where=PluginDescriptor.WHERE_PLUGINMENU, fnc=main, icon="plugin.png")]