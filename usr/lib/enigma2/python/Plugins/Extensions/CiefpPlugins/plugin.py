...
class CiefpPluginsPanel(Screen):
    skin = """
    <screen name="CiefpPluginsPanel" position="center,center" size="1600,850" title="..:: Ciefp Plugins (NO.38) ::.. (Version {version})">
    ...
    def __init__(self, session):
        ...
        self["title"] = Label(f"..:: Ciefp Plugins (NO.38) ::.. (Version {PLUGIN_VERSION})")
        self["actions"] = ActionMap(["OkCancelActions", "ColorActions", "DirectionActions"], {
            "cancel": self.exit,
            "red": self.exit,
...
def Plugins(**kwargs):
    ...
    return [PluginDescriptor(name="Ciefp Plugins", description=f"Panel for Ciefp plugins NO.38 (Version {PLUGIN_VERSION})", where=PluginDescriptor.WHERE_PLUGINMENU, fnc=main, icon="plugin.png")]